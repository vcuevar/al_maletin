...
Select	OITT.Code AS CODIGO, A3.ItemName AS DESCRIPCION, A3.InvntryUom AS UDMA, A1.ItemCode AS CODE, A1.ItemName AS MATERIAL, A1.InvntryUom AS UDMM, T1.Descr AS GRUPPLAN From OITT Inner Join ITT1 on ITT1.Father = OITT.Code Inner Join OITM A3 on OITT.Code = A3.ItemCode Inner Join OITM A1 on ITT1.Code = A1.ItemCode left join UFD1 T1 on A1.U_GrupoPlanea=T1.FldValue and T1.TableID='OITM' and T1.FieldID=9 Where T1.FldValue = 10 OR T1.FldValue = 18 OR T1.FldValue = 19 OR T1.FldValue = 9 OR T1.FldValue = 11 Order By A3.ItemName, A1.ItemName
