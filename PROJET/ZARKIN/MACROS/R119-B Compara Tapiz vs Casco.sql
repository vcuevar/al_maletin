...
Select	OWOR.DocEntry
		...
		, CP.U_CT AS ESTACION
		, SUBSTRING(RT.Name, 5,20)  AS FUNDA
From OWOR
...
-- Obtener Casco de Cada codigo

Select (A2.ItemCode + '  ' + A2.ItemName) AS CASCO 
From ITT1
Inner Join OITM A2 on A2.ItemCode = ITT1.Code and A2.U_TipoMat = 'CA'
Where ITT1.Father = '3707-07-B0132'
...
From ITT1
Inner Join OITM A2 on A2.ItemCode = ITT1.Code and A2.U_TipoMat = 'CA'
Where ITT1.Father = '3793-60-P0403'


Select (A2.ItemCode + '  ' + A2.ItemName) AS CASCO 
From ITT1
Inner Join OITM A2 on A2.ItemCode = ITT1.Code and A2.U_TipoMat = 'CA'
Where ITT1.Father = '379360-ESTRUCTURA'
