...
de la produccion  */
	...
	--Select Case When 
	--(Select	SUM(DATEPART(DW, CAST(T0.RateDate as DATE)) - DATEPART(DW, GETDATE())) as ALARMA
	--from ORTT T0
	...
	--'FALTA TIPO DE CAMBIO PARA PASADO MAÑANA' ELSE 'OK' END
...
-- Para cambiar el fondo del SAP a Lerma
	...
	*/
	...
	/*
	update OUSR set WallPaper = '\\Server-sapbo\b1_shr\LogoGaztambide.bmp'
	where WallPaper is null 
	*/
