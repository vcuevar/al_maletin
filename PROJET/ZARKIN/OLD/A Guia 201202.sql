...
-- Para definir valor cuando es nulo
ISNULL(A1.LastPurCur, 'MXP')
...
-- otro
, ISNULL((Select STUFF ((Select P.Price FROM PDN1 P
			WHERE P.ItemCode = '11294' AND Cast(P.DocDate as date) between '2020-12-01' and '2021-06-30' 
			FOR XML PATH ('')), 1, 0, '')), 'S/C') AS PRECC
