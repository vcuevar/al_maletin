...
*/
 ...
 Where  SIZ_MaterialesTraslados.EstatusLinea <> 'S' 
 and SIZ_SolicitudesMP.Id_Solicitud = 9825
 --and SIZ_SolicitudesMP.Status like 'Cancelada'
 --and SIZ_MaterialesTraslados.ItemCode = '10053'
  Order By SIZ_SolicitudesMP.Id_Solicitud


  Select * from SIZ_SolicitudesMP Where SIZ_SolicitudesMP.Id_Solicitud = 9825

  Select * from SIZ_MaterialesTraslados Where SIZ_MaterialesTraslados.Id_Solicitud = 9825 and SIZ_MaterialesTraslados.Id = 18751

  Update SIZ_MaterialesTraslados set Cant_Pendiente = 0, EstatusLinea = 'C' Where SIZ_MaterialesTraslados.Id_Solicitud = 9233 and SIZ_MaterialesTraslados.Id = 18750

  Update SIZ_SolicitudesMP set Status = 'Cerrada' Where SIZ_SolicitudesMP.Id_Solicitud = 9233
  
  
  Select * from SIZ_MaterialesTraslados  Where Id = 19814
