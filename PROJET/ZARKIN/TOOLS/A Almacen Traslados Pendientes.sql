...
*/
 ...
 SIZ_MaterialesTraslados.ItemCode = '18205'
  ...
  Select * from SIZ_SolicitudesMP Where SIZ_SolicitudesMP.Id_Solicitud = 4714

  Select * from SIZ_MaterialesTraslados Where SIZ_MaterialesTraslados.Id_Solicitud = 4714 --and EstatusLinea = 'S' --SIZ_MaterialesTraslados.ItemCode = '18205' and 


-- Para cancelar una solicitud.
  Update SIZ_MaterialesTraslados set Cant_Pendiente = 0, EstatusLinea = 'C' Where SIZ_MaterialesTraslados.Id_Solicitud = 4714 and EstatusLinea = 'S'

  Update SIZ_SolicitudesMP set Status = 'Cerrada' Where SIZ_SolicitudesMP.Id_Solicitud = 4714
