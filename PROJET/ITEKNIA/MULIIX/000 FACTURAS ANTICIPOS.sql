...
Select 'RESUMEN' AS DOC
 ...
 From OrdenesVenta
Inner Join (
Select ANTI.OV, SUM(ANTI.IMP_ANT) AS ANTIC, SUM(ANTI.IMP_APL) AS APLIC, (SUM(ANTI.IMP_ANT)-SUM(ANTI.IMP_APL)) AS SAL_ANT  
From
...
Select 'OV00751' AS OV, 'AJUST' AS DOC, 436816.36 as IMP_ANT, 0 as IMP_APL Union All
Select 'OV00696' as OV, 'AJUST' as DOC, 2416623.91 as IMP_ANT, 0 as IMP_APL Union All --Constructora Desarrolladora 
Select 'OV00833' as OV, 'AJUST' as DOC, 32758.62 as IMP_ANT, 0 as IMP_APL Union All
Select 'OV00784' as OV, 'AJUST' as DOC, 277988.90 as IMP_ANT, 0 as IMP_APL Union All 
Select 'OV00804' as OV, 'AJUST' as DOC, 50459.40 as IMP_ANT, 0 as IMP_APL Union All
Select 'OV00630' as OV, 'AJUST' as DOC, 191304 as IMP_ANT, 0 as IMP_APL Union All
Select 'OV00551' as OV, 'AJUST' as DOC, 35096.99 as IMP_ANT, 0 as IMP_APL Union All
Select 'OV00747' as OV, 'AJUST' as DOC, 384213.06 as IMP_ANT, 0 as IMP_APL 
) ANTI
Group By ANTI.OV
...
--Select 'OV00751' AS OV, 'AJUST' AS DOC, 436816.36 as IMP_ANT, 0 as IMP_APL Union All
Select 'OV00696' as OV, 'AJUST' as DOC, 2416623.91 as IMP_ANT, 0 as IMP_APL
