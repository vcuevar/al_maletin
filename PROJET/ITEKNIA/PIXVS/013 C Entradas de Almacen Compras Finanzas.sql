--  013C Consulta para Reporte de Entradas al Almacen Materiales (FINANZAS - PASIVO).
--  Ing. Vicente Cueva R.
--  Actualizado: 10 de Febrero del 2018; Origen.
--  Actualizado: 29 de Noviembre del 2018; Validar costo cuando son UMC.

Declare @FechaIS nvarchar(30), @FechaFS nvarchar(30)
--Parametros Fecha Inicial y Fecha Final
Set @FechaIS = '2018-11-26'
Set @FechaFS = '2018-11-26' 

-- Consulta
Select  OC_CodigoOC as ORDEN, OCRC_FechaRecibo AS F_RECIBO,
 CXPR_FechaReciboRegistro AS F_FACT, 
CXPR_FechaRegistro AS F_PASIVO, PRO_CodigoProveedor AS COD_PROV,
PRO_Nombre AS NOM_PROV, EV_CodigoEvento AS C_PROY, 
EV_Descripcion AS PROYECTO, ART_CodigoArticulo AS CODE_ART, 
...
and CXPR_RegistroBorrado = 0 and OC_MON_MonedaId = '748BE9C9-B56D-4FD2-A77F-EE4C6CD226A1' 
