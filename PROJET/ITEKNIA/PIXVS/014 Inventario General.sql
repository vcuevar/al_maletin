...
Select	AL.ALM_CodigoAlmacen as ALMACEN,
		...
		Convert(Decimal(28,10), A1.ART_CostoMaterialEstandar) as COS_EST,
...
Where EX.LOCA_Cantidad > 0 --and ART_CodigoArticulo = '0098'
...
Select ALM_CodigoAlmacen, ALM_Nombre, LOC_CodigoLocalidad, LOC_Nombre from Almacenes
Inner Join Localidades on LOC_ALM_AlmacenId = ALM_AlmacenId
where ALM_Borrado = 0 and LOC_Borrado = 0
